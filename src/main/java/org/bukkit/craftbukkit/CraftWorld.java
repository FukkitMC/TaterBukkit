...
public class CraftWorld implements World {
    ...
    public boolean generateTree(Location loc, TreeType type) {
        ...
        case CRIMSON_FUNGUS:
            ...
            conf = HugeFungusFeatureConfig.CRIMSON_FUNGUS_CONFIG;
            break;
        case WARPED_FUNGUS:
            gen = Feature.HUGE_FUNGUS;
            conf = HugeFungusFeatureConfig.WARPED_FUNGUS_CONFIG;
            break;
        case TREE:
        default:
            gen = Feature.TREE;
        ...
        return gen.generate(world, world.getStructureAccessor(), world.getChunkManager().getChunkGenerator(), rand, pos, conf);
    }
    ...
    public void setHardcore(boolean hardcore) {
        world.worldDataServer.field_25030.structures = true;
    }
    ...
    public void playSound(Location loc, String sound, org.bukkit.SoundCategory category, float volume, float pitch) {
        ...
        world.getServer().getPlayerList().sendToAround(null, x, y, z, volume > 1.0F ? 16.0F * volume : 16.0D, this.world.getRegistryKey(), packet);
    }
    ...
    public static synchronized Map<String, GameRules.Key<?>> getGameRulesNMS() {
        ...
        GameRules.forEachType(new GameRules.TypeConsumer() {
            @Override
            public <T extends GameRules.Rule<T>> void accept(GameRules.Key<T> gamerules_gamerulekey, GameRules.Type<T> gamerules_gameruledefinition) {
