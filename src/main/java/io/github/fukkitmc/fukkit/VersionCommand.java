...
public class VersionCommand extends Command {
    ...
    private void setVersionMessage(String msg) {
        ...
        } finally {versionLock.unlock();}
    }

    public static int check() {
        try {
            HttpURLConnection connection = (HttpURLConnection) new URL("https://api.github.com/repos/FukkitMC/TaterBukkit/compare/master..." + getGitHash()).openConnection();
            connection.connect();
    ...
    private static String getGitHash() {
        try {
            Class<?> version = Class.forName("io.github.fukkitmc.fukkit.GitVersion");
