...
public interface ServerPlayerEntityExtra {
    ...
    com.mojang.datafixers.util.Either<net.minecraft.entity.player.PlayerEntity.SleepFailureReason, net.minecraft.util.Unit> getBedResult(net.minecraft.util.math.BlockPos var0, net.minecraft.util.math.Direction var1);
    ...
    com.mojang.datafixers.util.Either<net.minecraft.entity.player.PlayerEntity.SleepFailureReason, net.minecraft.util.Unit> sleep(net.minecraft.util.math.BlockPos var0, boolean var1);
