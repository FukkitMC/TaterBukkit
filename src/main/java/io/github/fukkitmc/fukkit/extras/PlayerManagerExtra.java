...
public interface PlayerManagerExtra {
    ...
    net.minecraft.server.network.ServerPlayerEntity moveToWorld(net.minecraft.server.network.ServerPlayerEntity var0, net.minecraft.world.dimension.DimensionType var1, boolean var2, org.bukkit.Location var3, boolean var4);
