...
public interface BeehiveBlockEntityExtra {
    ...
    java.util.List<net.minecraft.entity.Entity> releaseBees(net.minecraft.block.BlockState var0, net.minecraft.block.entity.BeehiveBlockEntity.BeeState var1, boolean var2);
}
