...
public interface ServerWorldExtra {
    ...
    net.minecraft.server.world.ServerTickScheduler<net.minecraft.block.Block> getBlockTickList();
    ...
    <T extends net.minecraft.particle.ParticleEffect> int sendParticles(net.minecraft.server.network.ServerPlayerEntity var0, net.minecraft.particle.ParticleEffect var1, double var2, double var3, double var4, int var5, double var6, double var7, double var8, double var9, boolean var10);
    ...
    net.minecraft.server.world.ServerTickScheduler<net.minecraft.fluid.Fluid> getFluidTickList();
}
